...
Доробмо консольного бота помічника та додамо обробку помилок.
...
Додамо обробники до інших команд, та додати в декоратор обробку винятків інших типів. Бажаємо успіху при виконані домашнього завдання.
